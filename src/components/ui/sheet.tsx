...
const sideClasses = {
  ...
  top: "inset-x-0 top-0 h-auto max-h-[80vh] border-b data-open:slide-in-from-top data-closed:slide-out-to-top",
  bottom:
    "inset-x-0 bottom-0 h-auto max-h-[80vh] border-t data-open:slide-in-from-bottom data-closed:slide-out-to-bottom",
} as const
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover p-5 text-popover-foreground shadow-xl duration-200 outline-none data-open:animate-in data-closed:animate-out",
          sideClasses[side],
          className
        )}
        {...props}
