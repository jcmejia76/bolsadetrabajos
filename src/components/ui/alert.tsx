  ...
  "relative grid w-full grid-cols-[0_1fr] items-start gap-y-0.5 rounded-xl border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:gap-x-3 [&>svg]:size-4 [&>svg]:translate-y-0.5",
  {
    variants: {
      variant: {
        ...
        success:
          "border-emerald-500/20 bg-emerald-500/5 text-emerald-900 [&>svg]:text-emerald-600 dark:text-emerald-300",
        warning:
          "border-amber-500/20 bg-amber-500/5 text-amber-900 [&>svg]:text-amber-600 dark:text-amber-300",
        destructive:
